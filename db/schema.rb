...
ActiveRecord::Schema.define(version: 2020_10_11_044710) do
  ...
  create_table "deliveries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["item_purchase_id"], name: "index_deliveries_on_item_purchase_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "last_name_zenkaku_kanji", default: "", null: false
    t.string "first_name_zenkaku_kanji", default: "", null: false
  ...
  add_foreign_key "deliveries", "item_purchases"
